...
export declare class VgDashDirective implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<VgDashDirective, "[vgDash]", ["vgDash"], { "vgDash": "vgDash"; "vgDRMToken": "vgDRMToken"; "vgDRMLicenseServer": "vgDRMLicenseServer"; }, { "onGetBitrates": "onGetBitrates"; }, never, never, false>;
}
