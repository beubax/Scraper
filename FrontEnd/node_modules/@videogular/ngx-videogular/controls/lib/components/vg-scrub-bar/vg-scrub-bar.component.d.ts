...
export declare class VgScrubBarComponent implements OnInit, OnDestroy {
    ...
    protected seekEnd(offset: number | false): void;
    ...
    onTouchStartScrubBar(_$event: any): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<VgScrubBarComponent, "vg-scrub-bar", never, { "vgFor": "vgFor"; "vgSlider": "vgSlider"; }, {}, never, ["*"], false>;
}
